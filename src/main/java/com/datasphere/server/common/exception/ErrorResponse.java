...
public class ErrorResponse implements Serializable {
  ...
  public ErrorResponse(DSSException e) {
  ...
  public static ErrorResponse unknownError(Exception ex) {
    return new ErrorResponse(GlobalErrorCodes.DEFAULT_GLOBAL_ERROR_CODE, DSSException.DEFAULT_GLOBAL_MESSAGE, ExceptionUtils.getStackTrace(ex));
  }
